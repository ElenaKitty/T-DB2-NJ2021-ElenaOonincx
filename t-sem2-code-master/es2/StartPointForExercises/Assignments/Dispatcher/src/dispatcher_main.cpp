...
// If we would use a C file then we cannot use the Arduino Serial and other
// libraries, as these are C++ classes. If the dispatcher is called/included
// from/in a C file then this extern "C" is not needed but for now it sadly is
// needed...
//
